function Contact() {
  return (
    <section className=" bg-amber-50" id="contact">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <p className="text-base font-semibold uppercase tracking-wide text-amber-800">
              Contact
            </p>
          ...
          <div className="grid md:grid-cols-2">
            <div className="h-full pr-6">
              ...
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-amber-800 text-gray-50">
                    <svg
                ...
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-amber-900 text-gray-50">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
            ...
            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
              ...
              <form action="https://fabform.io/f/xxxxx" method="post">
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="w-full bg-amber-800 text-white px-6 py-3 font-xl rounded-md sm:mb-0"
                  >
                    Send Message
                  </button>
                </div>
